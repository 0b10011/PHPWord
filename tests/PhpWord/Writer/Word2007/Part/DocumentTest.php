...
//         $this->assertTrue($doc->elementExists('/Properties/property[name="key5"]/vt:lpwstr'));
    ...
    public function testWriteEndSectionPageNumbering()
    {
        ...
        $style->setBorderSize(Absolute::from('eop', 240));
    ...
    public function testWriteFontStyle()
    {
        ...
        $this->assertEquals($styles['color']->getColor(), $doc->getElementAttribute("{$parent}/w:color", 'w:val'));
        $this->assertEquals($styles['fgColor']->getColor(), $doc->getElementAttribute("{$parent}/w:highlight", 'w:val'));
