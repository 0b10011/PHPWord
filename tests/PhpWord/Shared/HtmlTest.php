...
HTML;
    ...
    public function testRoundTripImage()
    {
        $file = __DIR__ . '/../_files/temp.html';
        $html = <<<'HTML'
<!DOCTYPE html>
...
<body>
<p><img src="./tests/PhpWord/_files/images/mars.jpg" style="width: 20px; height: 20px;" /></p>
<p><img src="./tests/PhpWord/_files/images/mars.jpg" width="40" height="40" /></p>
</body>
</html>
...
HTML;
        ...
        $this->assertTrue(strpos(file_get_contents($file), 'style="width: 20px; height: 20px;"') !== false, 'Image width/height should be read and written from `style` attributes');

        $this->assertTrue(strpos(file_get_contents($file), 'style="width: 40px; height: 40px;"') !== false, 'Image width/height should be read and written from `width`/`height` attributes');
