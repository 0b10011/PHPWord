...
$fancyTableStyle = array('borderSize' => Absolute::from('twip', 6), 'borderColor' => new Hex('006699'), 'cellMargin' => Absolute::from('twip', 80), 'alignment' => \PhpOffice\PhpWord\SimpleType\JcTable::CENTER, 'cellSpacing' => Absolute::from('twip', 50));
...
$table = $section->addTable(array('width' => new Percent(50), 'alignment' => \PhpOffice\PhpWord\SimpleType\JcTable::CENTER));
...
$table = $section->addTable(array('borderSize' => Absolute::from('twip', 6), 'borderColor' => new Hex('999999'), 'position' => array('vertAnchor' => TablePosition::VANCHOR_TEXT, 'bottomFromText' => Converter::cmToTwip(1))));
$cell = $table->addRow()->addCell();
